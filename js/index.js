...
// useless
// Initialize video.js only on videos with a unique class
// document.querySelectorAll('.video-js').forEach(video => {
//     videojs(video);
// });

// Background video will just play automatically without controls
document.querySelectorAll('.events-navslide').forEach(div => {
