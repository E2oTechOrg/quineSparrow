!(function (e, t) {
  ...
  function u() {
    K.removeEventListener("DOMContentLoaded", u),
            ...
            "" === i.style.display &&
              ...
              (c[d] =
                ...
                (l = Ue[a]) ||
                  ...
                  "none" === l && (l = "block"),
                  (Ue[a] = l)))))
          : "none" !== n && ((c[d] = "none"), Le.set(i, "display", n)));
  ...
  function b(e, t, n, o, r) {
    ...
    for (p.textContent = "", h = 0; (s = f[h++]); )
      ...
      else if (((d = We(s)), (a = m(p.appendChild(s), "script")), d && w(a), n))
        for (u = 0; (s = a[u++]); ) Ye.test(s.type || "") && n.push(s);
    return p;
  }
  function x() {
    return !0;
              ...
              r.length &&
                (Le.set(this, t, {
                  value: he.event.trigger(
                    he.extend(r[0], he.Event.prototype),
                    r.slice(1),
                    this
                  ),
                }),
  ...
  function D(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        Le.hasData(e) &&
        ((r = Le.access(e)), (s = Le.set(t, r)), (c = r.events))
      )
        for (o in (delete s.handle, (s.events = {}), c))
          for (n = 0, i = c[o].length; n < i; n++) he.event.add(t, o, c[o][n]);
      He.hasData(e) &&
        ((a = He.access(e)), (l = he.extend({}, a)), He.set(t, l));
    }
  }
  function j(e, t, i, o) {
    t = te.apply([], t);
    var r,
      ...
      h = t[0],
      v = de(h);
    if (v || (1 < p && "string" == typeof h && !ce.checkClone && it.test(h)))
    ...
    if (
      p &&
      ((s = (r = b(t, e[0].ownerDocument, !1, e, o)).firstChild),
      1 === r.childNodes.length && (r = s),
      s || o)
    ) {
      for (l = (a = he.map(m(r, "script"), A)).length; u < p; u++)
        (c = r),
          u !== f &&
            ((c = he.clone(c, !0, !0)), l && he.merge(a, m(c, "script"))),
          i.call(e[u], c, u);
      if (l)
        for (d = a[a.length - 1].ownerDocument, he.map(a, E), u = 0; u < l; u++)
          (c = a[u]),
            Ye.test(c.type || "") &&
  ...
  function N(e, t, n) {
    for (var i, o = t ? he.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || he.cleanData(m(i)),
        i.parentNode &&
          (n && We(i) && w(m(i, "script")), i.parentNode.removeChild(i));
    return e;
  }
  function L(e, t, n) {
    var i,
  ...
  function q(e, t, n, i, o, r) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += he.css(e, n + Ie[s], !0, o)),
        i
          ? ("content" === n && (l -= he.css(e, "padding" + Ie[s], !0, o)),
            "margin" !== n &&
              (l -= he.css(e, "border" + Ie[s] + "Width", !0, o)))
          : ((l += he.css(e, "padding" + Ie[s], !0, o)),
            "padding" !== n
              ? (l += he.css(e, "border" + Ie[s] + "Width", !0, o))
              : (a += he.css(e, "border" + Ie[s] + "Width", !0, o)));
    return (
      !i &&
        0 <= r &&
        (l +=
  ...
  function M(e, t, n) {
    ...
    return (
      ((!ce.boxSizingReliable() && o) ||
        "auto" === s ||
        (!parseFloat(s) && "inline" === he.css(e, "display", !1, i))) &&
        e.getClientRects().length &&
        ((o = "border-box" === he.css(e, "boxSizing", !1, i)),
        (r = a in e) && (s = e[a])),
      (s = parseFloat(s) || 0) +
        q(e, t, n || (o ? "border" : "content"), r, i, s) +
        "px"
    );
  }
  ...
  function F(e, t, n) {
    for (
      var i,
        o = (B.tweeners[t] || []).concat(B.tweeners["*"]),
        r = 0,
        s = o.length;
      r < s;
      r++
  ...
  function B(e, t, n) {
    ...
    for (
      ...
      if ((i = B.prefilters[r].call(c, e, d, c.opts)))
        return (
          de(i.stop) &&
            (he._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)),
          i
        );
    return (
      he.map(d, F, c),
  ...
  var ge = (function (e) {
    function t(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : z) !== N && j(t), (t = t || N), H)
      ) {
        if (11 !== h && (l = ye.exec(e)))
          if ((o = l[1])) {
            if (9 === h) {
      ...
      return (
        ...
        i(function (i, a, l, c) {
          var d,
            ...
            m = !e || (!i && n) ? y : g(y, f, e, l, c),
            w = o ? (s || (i ? e : v || r) ? [] : a) : m;
          if ((o && o(m, w, l, c), r))
            for (d = g(w, h), r(d, [], l, c), u = d.length; u--; )
              (p = d[u]) && (w[h[u]] = !(m[h[u]] = p));
          if (i) {
            if (s || e) {
              if (s) {
          ...
          } else (w = g(w === a ? w.splice(v, w.length) : w)), s ? s(null, a, w, c) : J.apply(a, w);
        })
      );
    }
    function m(e) {
      for (
        ...
        if ((n = x.relative[e[a].type])) d = [h(v(d), n)];
        else {
    ...
    try {
      J.apply((V = K.call(z.childNodes)), z.childNodes),
      ...
      function (e) {
        ...
        return (
          i !== N &&
            ...
            (b.getElementsByClassName = ge.test(N.getElementsByClassName)),
    ...
    (t.attr = function (e, t) {
      ...
      var n = x.attrHandle[t.toLowerCase()],
        i = n && Y.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !H) : void 0;
      return void 0 !== i
        ? i
        : b.attributes || !H
        ? e.getAttribute(t)
    ...
    return (
      ...
      (C = t.compile =
        function (e, n) {
          var o,
            ...
            p = U[e + " "];
          if (!p) {
            for (n || (n = S(e)), o = n.length; o--; )
              (p = m(n[o]))[I] ? d.push(p) : u.push(p);
            (p = U(
              e,
              ((r = u),
              (a = 0 < (s = d).length),
              ...
              (c = function (e, n, i, o, c) {
                ...
                for (
                  ...
                  if (l && d) {
                    for (
                      u = 0, n || d.ownerDocument === N || (j(d), (i = !H));
                      (p = r[u++]);
                  ...
                  a && ((d = !p && d) && f--, e && v.push(d));
                }
                if (((f += h), a && h !== f)) {
                  for (u = 0; (p = s[u++]); ) p(v, y, n, i);
                  if (e) {
                    if (0 < f) for (; h--; ) v[h] || y[h] || (y[h] = G.call(o));
                    y = g(y);
                  }
                  J.apply(o, y),
                    c &&
      ...
      (b.sortStable = I.split("").sort(_).join("") === I),
  ...
  (he.filter = function (e, t, n) {
    ...
    he.fn.extend({
      ...
      is: function (e) {
        return !!s(
          this,
          "string" == typeof e && we.test(e) ? he(e) : e || [],
          !1
        ).length;
      },
    });
    ...
    if (((n = n || xe), "string" == typeof e)) {
      ...
      if (i[1]) {
        if (
          ...
          he.merge(
            this,
            he.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : K, !0)
          ),
      ...
      function (e, t) {
        he.fn[e] = function (n, i) {
          ...
          return (
            ...
            1 < this.length &&
              (Se[e] || he.uniqueSort(o), ke.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
    ...
    var o,
      ...
      p = {
        add: function () {
          return (
            l &&
              (r && !o && ((d = l.length - 1), c.push(r)),
              (function t(n) {
                he.each(n, function (n, o) {
                  de(o)
                    ? (e.unique && p.has(o)) || l.push(o)
    ...
    he.extend({
        ...
        var n = [
          ...
          o = {
            ...
            then: function (t, i, o) {
              ...
              return he
                .Deferred(function (e) {
                  n[0][3].add(r(0, e, de(o) ? o : l, e.notifyWith)),
                    n[1][3].add(r(0, e, de(t) ? t : l)),
                    n[2][3].add(r(0, e, de(i) ? i : c));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          ...
          "pending" === r.state() || de(o[n] && o[n].then))
        )
          return r.then();
  ...
  (he.fn.ready = function (e) {
    ...
    ("loading" !== K.readyState && !K.documentElement.doScroll)
      ...
      : (K.addEventListener("DOMContentLoaded", u),
  ...
  var Ee = function (e, t, n, o, r, s, a) {
      var l = 0,
        ...
        d = null == n;
      if ("object" === i(n))
        for (l in ((r = !0), n)) Ee(e, t, l, n[l], !0, s, a);
      else if (
        void 0 !== o &&
        ((r = !0),
        de(o) || (a = !0),
    ...
    he.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((o = He.get(r)), 1 === r.nodeType && !Le.get(r, "hasDataAttrs"))
          ) {
            for (n = s.length; n--; )
              s[n] &&
                0 === (i = s[n].name).indexOf("data-") &&
                ((i = f(i.slice(5))), v(r, i, o[i]));
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!i || Array.isArray(n)
                ? (i = Le.access(e, t, he.makeArray(n)))
                : i.push(n)),
            i || []
          );
      },
  ...
  ze.getRootNode &&
    (We = function (e) {
      return (
        he.contains(e.ownerDocument, e) || e.getRootNode(Re) === e.ownerDocument
      );
    });
  var Fe = function (e, t) {
      return (
        "none" === (e = t || e).style.display ||
        ("" === e.style.display && We(e) && "none" === he.css(e, "display"))
      );
    },
    Be = function (e, t, n, i) {
      var o,
  ...
  var Ge,
    Qe,
    Je = /<|&#?\w+;/;
  (Ge = K.createDocumentFragment().appendChild(K.createElement("div"))),
    (Qe = K.createElement("input")).setAttribute("type", "radio"),
    Qe.setAttribute("checked", "checked"),
    Qe.setAttribute("name", "t"),
    Ge.appendChild(Qe),
    (ce.checkClone = Ge.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (Ge.innerHTML = "<textarea>x</textarea>"),
    (ce.noCloneChecked = !!Ge.cloneNode(!0).lastChild.defaultValue);
  var Ke = /^key/,
  ...
  (he.event = {
      ...
      if (g)
        for (
          n.handler && ((n = (r = n).handler), (o = r.selector)),
            o && he.find.matchesSelector(ze, o),
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = he.event.handlers.call(this, a, c), t = 0;
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            Xe.test(t.type) && t.click && r(t, "input") && C(t, "click", x), !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            Xe.test(t.type) && t.click && r(t, "input") && C(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  he.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = m(d), i = 0, o = (r = m(e)).length; i < o; i++)
          (a = r[i]),
            (l = s[i]),
      ...
      if (t)
        if (n)
          for (r = r || m(e), s = s || m(d), i = 0, o = r.length; i < o; i++)
            D(r[i], s[i]);
        else D(e, d);
    ...
    he.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (he.cleanData(m(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return Ee(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !nt.test(e) &&
              !Ve[(_e.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = he.htmlPrefilter(e);
              try {
                for (; n < i; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (he.cleanData(m(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return j(
          ...
          function (t) {
            ...
            he.inArray(this, e) < 0 &&
              (he.cleanData(m(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
  ...
  var rt = new RegExp("^(" + qe + ")(?!px)[a-z%]+$", "i"),
    st = function (t) {
      var n = t.ownerDocument.defaultView;
      return (n && n.opener) || (n = e), n.getComputedStyle(t);
    },
    at = new RegExp(Ie.join("|"), "i");
  !(function () {
    function t() {
      if (c) {
        (l.style.cssText =
          ...
          ze.appendChild(l).appendChild(c);
  ...
  he.extend({
    ...
    he.each(["height", "width"], function (e, t) {
      he.cssHooks[t] = {
        get: function (e, n, i) {
          if (n)
            return !ut.test(he.css(e, "display")) ||
    ...
    (he.cssHooks.marginLeft = H(ce.reliableMarginLeft, function (e, t) {
      if (t)
        return (
      ...
      _default: {
        ...
        set: function (e) {
          he.fx.step[e.prop]
            ? he.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!he.cssHooks[e.prop] && null == e.elem.style[O(e.prop)])
            ? (e.elem[e.prop] = e.now)
  ...
  (he.Animation = he.extend(B, {
          ...
          f))
            l ||
              (g
                ...
                : (g = Le.access(e, "fxshow", { display: c })),
              r && (g.hidden = !v),
              v && y([e], !0),
              p.done(function () {
                for (i in (v || y([e]), Le.remove(e, "fxshow"), f))
                  he.style(e, i, f[i]);
              })),
              (l = F(v ? g[i] : 0, i, p)),
              i in g ||
    ...
    (yt = K.createElement("input")),
    (mt = K.createElement("select").appendChild(K.createElement("option"))),
    (yt.type = "checkbox"),
    (ce.checkOn = "" !== yt.value),
    (ce.optSelected = mt.selected),
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && i
          ...
          : this.each(function () {
              var t, o, r, s;
              if (i)
                for (o = 0, r = he(this), s = _(e); (t = s[o++]); )
                  r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = X(this)) && Le.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      t || !1 === e ? "" : Le.get(this, "__className__") || ""
                    ));
            });
      },
      hasClass: function (e) {
        var t,
          ...
          i = 0;
        for (t = " " + e + " "; (n = this[i++]); )
          if (1 === n.nodeType && -1 < (" " + U(X(n)) + " ").indexOf(t))
            return !0;
        return !1;
      },
    });
  ...
  he.fn.extend({
    val: function (e) {
      ...
      return arguments.length
        ...
        : o
        ? (t = he.valHooks[o.type] || he.valHooks[o.nodeName.toLowerCase()]) &&
          "get" in t &&
    ...
    he.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, i, o = e.options, r = he.makeArray(t), s = o.length;
              s--;

            )
              ((i = o[s]).selected =
                -1 < he.inArray(he.valHooks.option.get(i), r)) && (n = !0);
  ...
  he.extend(he.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          8 !== i.nodeType &&
          !$t.test(h + he.event.triggered) &&
          (-1 < h.indexOf(".") && ((h = (v = h.split(".")).shift()), v.sort()),
          (c = h.indexOf(":") < 0 && "on" + h),
          ((t = t[he.expando]
            ? t
            : new he.Event(h, "object" == typeof t && t)).isTrigger = o
            ? 2
            : 3),
          (t.namespace = v.join(".")),
        ...
        for (r = 0; (s = f[r++]) && !t.isPropagationStopped(); )
          (p = s),
            (t.type = 1 < r ? l : u.bindType || h),
            (d = (Le.get(s, "events") || {})[t.type] && Le.get(s, "handle")) &&
              d.apply(s, n),
            (d = c && s[c]) &&
              d.apply &&
              Ne(s) &&
      ...
      he.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
        ...
        he.event.special[t] = {
          ...
          teardown: function () {
            ...
            o
              ? Le.access(i, t, o)
              : (i.removeEventListener(e, n, !0), Le.remove(i, t));
          },
        };
      });
  var Et = e.location,
  ...
  (Ut.href = Et.href),
    he.extend({
      ...
      ajax: function (t, n) {
        ...
        h.ifModified &&
          (he.lastModified[r] &&
            k.setRequestHeader("If-Modified-Since", he.lastModified[r]),
  ...
  (ce.cors = !!_t && "withCredentials" in _t),
    (ce.ajax = _t = !!_t),
    he.ajaxTransport(function (t) {
      var n, i;
      if (ce.cors || (_t && !t.crossDomain))
        return {
          send: function (o, r) {
            var s,
              a = t.xhr();
  ...
  he.ajaxSetup({
    ...
    (ce.createHTMLDocument =
      (((Yt = K.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    (he.fn.load = function (e, t, n) {
      var i,
        ...
        a = e.indexOf(" ");
      return (
        -1 < a && ((i = U(e.slice(a))), (e = e.slice(0, a))),
        de(t)
          ? ((n = t), (t = void 0))
        ...
        if (this[0]) {
          ...
          if ("fixed" === he.css(i, "position")) t = i.getBoundingClientRect();
            ...
            e &&
              e !== i &&
              1 === e.nodeType &&
              (((o = he(e).offset()).top += he.css(e, "borderTopWidth", !0)),
    ...
    he.each(["top", "left"], function (e, t) {
      he.cssHooks[t] = H(ce.pixelPosition, function (e, n) {
        if (n)
          return (n = L(e, t)), rt.test(n) ? he(e).position()[t] + "px" : n;
      });
    }),
  ...
  return (
    (he.noConflict = function (t) {
      return (
        e.$ === he && (e.$ = Jt), t && e.jQuery === he && (e.jQuery = Qt), he
      );
    }),
    t || (e.jQuery = e.$ = he),
    he
